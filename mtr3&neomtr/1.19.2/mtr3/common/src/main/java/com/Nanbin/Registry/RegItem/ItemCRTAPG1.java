...
/**
 * CRT 第一代矮屏蔽门系列物品（门 / 玻璃 / 端部玻璃）。
 * 门会一次性放置为并排 2 格、上下 2 格；玻璃与端部玻璃为 1 格宽、上下 2 格。
 *
 * @see com.Nanbin.Registry.RegBlock.BlockCRTAPGDoor1
 * @see com.Nanbin.Registry.RegBlock.BlockCRTAPGGlass1
 * @see com.Nanbin.Registry.RegBlock.BlockCRTAPGGlassEnd1
 */
public class ItemCRTAPG1 extends Item {

	private final Block block;

	public ItemCRTAPG1(Block block, Settings settings) {
		super(settings);
		this.block = block;
	}
