...
public class BlockSoundproofNetTop extends BlockDirectionalMapper {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView blockGetter, BlockPos pos, ShapeContext collisionContext) {
        VoxelShape shape1 = IBlock.getVoxelShapeByDirection(0, 12, 0, 16, 14, 16, (Direction)state.get(FACING));
        VoxelShape shape2 = IBlock.getVoxelShapeByDirection(0, 0, 0, 16, 14, 2, (Direction)state.get(FACING));
