 ...
 * 渲染由 {@link com.Nanbin.client.Render.RenderCRTStationName2} 完成。
 */
public class BlockCRTStationName2 extends HorizontalFacingBlock implements BlockEntityProvider {

	public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

	public BlockCRTStationName2(Settings settings) {
		super(settings);
	...
	public static class BlockEntity extends BlockRouteSignBase.TileEntityRouteSignBase {
		...
		public static ResolvedRouteData resolveRouteData(long platformId, int fallbackColor, String syncedRouteNumber) {
			...
			try {
				...
				Init.LOGGER.error("[CRTStationName2]: Error resolving route data for platform {}", platformId, e);
			}
