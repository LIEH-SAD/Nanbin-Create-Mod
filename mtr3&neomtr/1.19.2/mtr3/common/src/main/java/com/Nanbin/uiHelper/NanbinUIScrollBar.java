...
public class NanbinUIScrollBar {
	...
	public void render(MatrixStack matrices, int contentHeight, int viewHeight, double scroll) {
		...
		DrawableHelper.fill(matrices, x, y, x + WIDTH, y + height, TRACK_COLOR);
		DrawableHelper.fill(matrices, x, thumbY, x + WIDTH, thumbY + thumbHeight, THUMB_COLOR);
	}
