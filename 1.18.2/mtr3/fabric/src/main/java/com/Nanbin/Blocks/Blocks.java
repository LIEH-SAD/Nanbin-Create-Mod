...
public class Blocks {
    ...
    public static final Block CRT_TICKET_MACHINE_1 = new BlockCRTTicketMachine1(FabricBlockSettings.of(Material.METAL));
    ...
    public static final Block CRT_LIFT_TIPS_3 = new BlockMTRLogo(FabricBlockSettings.of(Material.GLASS).hardness(16.0f));
    public static final Block CRT_FENCE1 = new BlockGlassFence();
    public static final Block CRT_FENCE8 = new BlockGlassFence();
    public static final Block CRT_FENCE9 = new BlockGlassFence();
    public static final Block CRT_APG_CAB_DOOR_OLD = new BlockOrdinaryPSDCabDoor(FabricBlockSettings.of(Material.GLASS).hardness(16.0f).nonOpaque());
    public static final Block CRT_APG_CAB_DOOR_NEW = new BlockOrdinaryPSDCabDoor(FabricBlockSettings.of(Material.GLASS).hardness(16.0f).nonOpaque());
    public static final Block SOUNDPROOFNET_TOP = new BlockSoundproofNetTop(FabricBlockSettings.of(Material.METAL));
    public static final Block SOUNDPROOFNET_GLASS = new BlockSoundproofNetBase(FabricBlockSettings.of(Material.GLASS));
    public static final Block SOUNDPROOFNET_BASE = new BlockSoundproofNetBase(FabricBlockSettings.of(Material.METAL));
    ...
    public static final Block ORDINARY_PSD_CAB_DOOR = new BlockOrdinaryPSDCabDoor(FabricBlockSettings.copyOf(net.minecraft.block.Blocks.IRON_DOOR));
    ...
    public static void onInitialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier("nanbin", "crt_ticket_machine_1"), new BlockItem(CRT_TICKET_MACHINE_1, new Item.Settings().group(ItemsGroup.CRT)));
        Registry.register(Registry.BLOCK, new Identifier("nanbin", "crt_ticket_machine_1"), CRT_TICKET_MACHINE_1);
        ...
        Registry.register(Registry.ITEM, new Identifier("nanbin", "crt_lift_tips_3"), new BlockItem(CRT_LIFT_TIPS_3, new Item.Settings().group(ItemsGroup.CRT)));
        Registry.register(Registry.BLOCK, new Identifier("nanbin", "crt_lift_tips_3"), CRT_LIFT_TIPS_3);
        ...
        Registry.register(Registry.ITEM, new Identifier("nanbin", "crt_apg_cab_door_old"), new BlockItem(CRT_APG_CAB_DOOR_OLD, new Item.Settings().group(ItemsGroup.CRT)));
        Registry.register(Registry.BLOCK, new Identifier("nanbin", "crt_apg_cab_door_old"), CRT_APG_CAB_DOOR_OLD);

        Registry.register(Registry.ITEM, new Identifier("nanbin", "crt_apg_cab_door_new"), new BlockItem(CRT_APG_CAB_DOOR_NEW, new Item.Settings().group(ItemsGroup.CRT)));
        Registry.register(Registry.BLOCK, new Identifier("nanbin", "crt_apg_cab_door_new"), CRT_APG_CAB_DOOR_NEW);

        Registry.register(Registry.ITEM, new Identifier("nanbin", "ordinary_psd_cab_door"), new BlockItem(ORDINARY_PSD_CAB_DOOR, new Item.Settings().group(ItemsGroup.USING_STATION_BUILDING_BLOCKS)));
        Registry.register(Registry.BLOCK, new Identifier("nanbin", "ordinary_psd_cab_door"), ORDINARY_PSD_CAB_DOOR);
        ...
        Registry.register(Registry.ITEM, new Identifier("nanbin", "soundproofnet_top"), new BlockItem(SOUNDPROOFNET_TOP, new Item.Settings().group(ItemsGroup.USING_RAILWAY_BUILD)));

        Registry.register(Registry.BLOCK, new Identifier("nanbin", "soundproofnet_base"), SOUNDPROOFNET_BASE);
        Registry.register(Registry.ITEM, new Identifier("nanbin", "soundproofnet_base"), new BlockItem(SOUNDPROOFNET_BASE, new Item.Settings().group(ItemsGroup.USING_RAILWAY_BUILD)));

        Registry.register(Registry.BLOCK, new Identifier("nanbin", "soundproofnet_glass"), SOUNDPROOFNET_GLASS);
        Registry.register(Registry.ITEM, new Identifier("nanbin", "soundproofnet_glass"), new BlockItem(SOUNDPROOFNET_GLASS, new Item.Settings().group(ItemsGroup.USING_RAILWAY_BUILD)));
