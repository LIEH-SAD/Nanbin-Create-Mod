    ...
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
        if (!world.isClient && entity instanceof PlayerEntity) {
            ...
            if (open.isOpen() && playerPosRotated.z > (double)0.0F) {
                ...
                TicketSystem.EnumTicketBarrierOpen newOpen = TicketSystem.passThrough(world, pos, (PlayerEntity)entity, this.isEntrance, !this.isEntrance, NanbinSoundEvents.CRT_TICKET, NanbinSoundEvents.CRT_TICKET, NanbinSoundEvents.CRT_TICKET, NanbinSoundEvents.CRT_TICKET, (SoundEvent)null, false);
