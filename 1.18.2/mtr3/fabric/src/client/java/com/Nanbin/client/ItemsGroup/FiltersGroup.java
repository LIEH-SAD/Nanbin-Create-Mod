...
public final class FiltersGroup {
    ...
    public static void onInitialize() {
        CRT_FENCE = FilterBuilder.registerFilter(ItemsGroup.CRT, new TranslatableText("FiltersGroup.nanbin.crt_fence"), () -> new ItemStack(Blocks.CRT_FENCE1))
                .addItems(Blocks.CRT_FENCE1.asItem())
                .addItems(Blocks.CRT_FENCE8.asItem())
                .addItems(Blocks.CRT_FENCE9.asItem());

        CRT_BUILDING_BLOCKS = FilterBuilder.registerFilter(ItemsGroup.CRT, new TranslatableText("FiltersGroup.nanbin.crt_building_blocks"), () -> new ItemStack(Blocks.CRT_LOGO))
        ...
        CRT_TICKETS = FilterBuilder.registerFilter(ItemsGroup.CRT, new TranslatableText("FiltersGroup.nanbin.crt_tickets"), () -> new ItemStack(Blocks.CRT_TICKET_1_EXIT))
        ...
        CRT_DOOR = FilterBuilder.registerFilter(ItemsGroup.CRT, new TranslatableText("FiltersGroup.nanbin.crt_door"), () -> new ItemStack(Blocks.CRT_APG_CAB_DOOR_NEW.asItem()))
        ...
        COMMON_BUILDING_BLOCKS = FilterBuilder.registerFilter(ItemsGroup.CITY_BUILDING_BLOCKS, new TranslatableText("FiltersGroup.nanbin.common_building_blocks"), () -> new ItemStack(Blocks.NANBIN_BLUE_BLOCK))
        ...
        ROAD_BLOCKS = FilterBuilder.registerFilter(ItemsGroup.CITY_BUILDING_BLOCKS, new TranslatableText("FiltersGroup.nanbin.road_blocks"), () -> new ItemStack(Blocks.YELLOW_TACTILE_BAVING))
        ...
        FENCE_BLOCKS = FilterBuilder.registerFilter(ItemsGroup.CITY_BUILDING_BLOCKS, new TranslatableText("FiltersGroup.nanbin.fence_blocks"), () -> new ItemStack(Blocks.BLUEFENCE))
