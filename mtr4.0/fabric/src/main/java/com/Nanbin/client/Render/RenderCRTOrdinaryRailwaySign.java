...
import com.Nanbin.Registry.RegBlock.BlockCRTOrdinaryRailwaySign;
...
public class RenderCRTOrdinaryRailwaySign extends BlockEntityRenderer<BlockCRTOrdinaryRailwaySign.BlockEntity> implements IBlock, IGui, IDrawing {
	...
	private static final FontType FONT_TYPE_2 = FontType.SOURCE_SANS_3; // 圆内文字字体（数字用 Source Sans 3）
	...
	public RenderCRTOrdinaryRailwaySign(Argument dispatcher) {
		super(dispatcher);
	}

	@Override
	public void render(BlockCRTOrdinaryRailwaySign.BlockEntity entity, float tickDelta, GraphicsHolder graphicsHolder, int light, int overlay) {
	...
	private void renderSide(StoredMatrixTransformations base, World world, BlockPos pos, BlockState state, Direction facing, String stationName, int stationColor, int shadingColor, int light, BlockCRTOrdinaryRailwaySign.BlockEntity entity) {
