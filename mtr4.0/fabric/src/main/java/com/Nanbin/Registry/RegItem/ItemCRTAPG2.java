...
/**
 * @author LIEH-SAD
 * @see BlockCRTAPGDoor2
 * @see BlockCRTAPGGlass2
 * @see BlockCRTAPGGlassEnd2
 */

public class ItemCRTAPG2 extends ItemExtension implements IBlock
{
    public final Block block;

    public ItemCRTAPG2(BlockRegistryObject block, ItemSettings settings) {
        super(settings);
