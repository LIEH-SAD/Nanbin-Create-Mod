...
public class BlockOrdinaryStationName extends BlockStationNameBase implements DirectionHelper, BlockWithEntity {

    public BlockOrdinaryStationName(BlockSettings blockSettings) {
        super(blockSettings);
    }
