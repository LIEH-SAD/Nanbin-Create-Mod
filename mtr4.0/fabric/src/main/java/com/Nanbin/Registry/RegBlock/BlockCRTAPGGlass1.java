...
public class BlockCRTAPGGlass1 extends BlockPSDAPGGlassBase implements DirectionHelper {
    ...
    private boolean isSameGlass(World world, BlockPos pos) {
        return world.getBlockState(pos).getBlock().data instanceof BlockCRTAPGGlass1;
    }
