...
public class BlockCRTOrdinaryRailwaySign extends BlockStationNameBase implements DirectionHelper, BlockWithEntity {

    public BlockCRTOrdinaryRailwaySign(BlockSettings blockSettings) {
        super(blockSettings);
    }
    ...
    public static class BlockEntity extends BlockRouteSignBase.BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.CRT_ORDINARY_RAILWAY_SIGN.get(), pos, state);
        }
        ...
        public void setData(long platformId) {
            ...
            if (blockEntity.data instanceof BlockEntity entity) {
                ...
                Init.LOGGER.error("BlockCRTOrdinaryRailwaySign.BlockEntity: Unable to set data for block entity at {}", pos.toShortString());
            }
            markDirty2();
        }
        ...
        private void updateRouteNumberFromServer() {
            ...
            try {
                ...
                Init.LOGGER.error("BlockCRTOrdinaryRailwaySign: Failed to fetch route number for platform {}", platformId, e);
            }
        }
    }
}
