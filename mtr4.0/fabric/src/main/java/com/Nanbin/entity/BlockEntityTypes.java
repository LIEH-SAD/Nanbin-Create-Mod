...
public class BlockEntityTypes {
    ...
    public static final BlockEntityTypeRegistryObject<BlockCRTOrdinaryRailwaySign.BlockEntity> CRT_ORDINARY_RAILWAY_SIGN;
    ...
    static {
        ...
        CRT_ORDINARY_RAILWAY_SIGN = Init.REGISTRY.registerBlockEntityType(new Identifier("nanbin", "crt_ordinary_railway_sign"), BlockCRTOrdinaryRailwaySign.BlockEntity::new, Blocks.CRT_ORDINARY_RAILWAY_SIGN::get);
