...
public abstract class DoorBlockExtension extends org.mtr.mapping.mapper.DoorBlockExtension {
	...
	protected static boolean isRightHinge(BlockState state) {
		return state.get(new Property<>(net.minecraft.state.property.Properties.DOOR_HINGE)) == net.minecraft.block.enums.DoorHinge.RIGHT;
	}

	protected static boolean isUpperHalf(BlockState state) {
		return state.get(new Property<>(net.minecraft.block.DoorBlock.HALF)) == net.minecraft.block.enums.DoubleBlockHalf.UPPER;
	}
}