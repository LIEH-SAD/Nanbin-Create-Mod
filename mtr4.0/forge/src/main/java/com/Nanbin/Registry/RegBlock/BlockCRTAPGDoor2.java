...
public class BlockCRTAPGDoor2 extends BlockPSDAPGDoorBase implements BlockWithEntity {
    ...
    public VoxelShape getOutlineShape2(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        return half ? IBlock.getVoxelShapeByDirection(0, 0, 0, 16, 10, 4, facing) : IBlock.getVoxelShapeByDirection(0, 0, 0, 16, 16, 4, facing);
    }
    ...
    public static class BlockEntity extends BlockEntityBase {
        ...
        public BlockEntity(BlockPos pos, BlockState state) {
            super(BlockEntityTypes.CRT_APG_DOOR_2.get(), pos, state);
        }
        ...
        private long predictNextArrival() {
            ...
            try {
                ...
                Init.LOGGER.error("[CRTAPGDoor2] predictNextArrival error", e);
            }
            return 0;
        }
        ...
        private static long tryGetNextArrival(Platform platform) {
            try {
                ...
                Init.LOGGER.error("[CRTAPGDoor2] tryGetNextArrival.getNextArrival error", e);
            }
            try {
                    ...
                    try {
                        ...
                        if (schedule != null) {
                            try {
                                ...
                                Init.LOGGER.error("[CRTAPGDoor2] tryGetNextArrival.getNextDeparture error", e);
                            }
                        }
                    } catch (NoSuchMethodException ignored) {
                    } catch (Exception e) {
                        Init.LOGGER.error("[CRTAPGDoor2] tryGetNextArrival.getSchedule error", e);
                    }
                }
                ...
                Init.LOGGER.error("[CRTAPGDoor2] tryGetNextArrival error", e);
            }
            return 0;
        }
