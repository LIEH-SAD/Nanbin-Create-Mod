...
public class BlockBlueFenceTop extends BlockExtension {
    ...
    public BlockBlueFenceTop(BlockSettings settings) {
        super(settings);
    }
    ...
    public void onStateReplaced2(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        ...
        if (!state.isOf(newState.getBlock())) {
            ...
            // 如果下方是 BLUEFENCE 方块，则破坏它
            if (downState.getBlock().data instanceof BlockBlueFence) {
