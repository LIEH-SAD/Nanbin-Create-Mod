...
public class BlockEntityRender {
    ...
    public static void init(){
        ...
        REGISTRY_CLIENT.registerBlockEntityRenderer(BlockEntityTypes.ORDINARY_STATION_NAME, RenderOrdinaryStationName::new);
        ...
        REGISTRY_CLIENT.registerBlockEntityRenderer(BlockEntityTypes.CRT_STATION_INFO_1_DOUBLE, RenderCRTStationInfo1Double::new);
    }
}