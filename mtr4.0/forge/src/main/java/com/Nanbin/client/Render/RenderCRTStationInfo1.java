		...
		if (signIds != null) {
			...
			for (int i = 0; i < signIds.length; i++) {
				...
				if (lineStyleScriptId != null) {
					...
					RenderCRTRailwaySign.renderJSStyleLine(lineStyleScriptId, matrix, pos, lineIds, lineSelected, entity.getRouteNumbers(), facing, 0, DOUBLE_SIGN_CELL, DOUBLE_SIGN_LEFT, DOUBLE_SIGN_TOP + i * DOUBLE_SIGN_CELL, true, routeNumberMap);
					continue;
				}
