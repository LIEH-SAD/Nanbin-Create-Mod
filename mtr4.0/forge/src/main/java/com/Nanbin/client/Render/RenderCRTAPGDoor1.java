...
public class RenderCRTAPGDoor1<T extends BlockCRTAPGDoor1.BlockEntityBase> extends BlockEntityRenderer<T> implements IGui, IBlock {
    ...
    private static final ModelSingleCube CRT_APG_DOOR_NUMBER_1 = new ModelSingleCube(16, 16, 10, 4, 2, 3, 3, 0.1F);
    ...
    private int getDoorNumberCached(World world, BlockPos blockPos) {
        ...
        final int number = APGDoorNumbering.getDoorNumber(world, blockPos, IBlock.getStatePropertySafe(world, blockPos, BlockCRTAPGDoor1.SORT_FROM_RIGHT));
    ...
    private int getDoorLineColor(BlockPos doorPos) {
        try {
            ...
            InitClient.LOGGER.error("[CRTAPGDoor1] failed to resolve door line color", e);
        }
        return 0xFF929498;
    }
    ...
    private void renderDoorNumberPlate(World world, BlockPos blockPos, StoredMatrixTransformations storedMatrixTransformations, int light, int overlay) {
        ...
        if (doorNumber > 0) {
            ...
            MainRenderer.scheduleRender(plateTexture, false, QueuedRenderLayer.EXTERIOR, (graphicsHolder, offset) -> {
                ...
                CRT_APG_DOOR_NUMBER_1.render(graphicsHolder, light, overlay, 1.0F, 1.0F, 1.0F, 1.0F);
                graphicsHolder.pop();
            });
             */
        }
