...
import com.Nanbin.mappingForge.IBlockExtension;
...
public abstract class BlockCustomColorBase extends BlockExtension implements BlockWithEntity
{
    ...
    public ActionResult onUse2(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        return IBlockExtension.checkHoldingBrush(world, player, () -> Init.REGISTRY.sendPacketToClient(ServerPlayerEntity.cast(player), new PacketOpenBlockEntityScreen(pos)));
    }
