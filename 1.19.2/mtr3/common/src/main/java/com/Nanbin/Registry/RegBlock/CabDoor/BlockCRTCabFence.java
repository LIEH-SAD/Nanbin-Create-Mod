...
public class BlockCRTCabFence extends BlockDirectionalDoubleBlockBase {
    ...
    public BlockCRTCabFence(Settings settings) {
        super(settings);
    }
    ...
    public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        Direction facing = (Direction)IBlock.getStatePropertySafe(state, FACING);
        return VoxelShapes.union(this.getOutlineShape(state, world, pos, context), IBlock.getVoxelShapeByDirection(0, 0, 0, 16, 16, 3, facing));
    }
