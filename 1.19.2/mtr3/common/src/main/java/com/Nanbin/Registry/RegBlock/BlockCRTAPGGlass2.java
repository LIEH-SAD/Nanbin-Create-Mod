...
/**
 * CRT 第二代矮屏蔽门玻璃（APG 玻璃）。用刷子点击玻璃上部可按 1 / 2 / 3 联动
 * 重新划分一组玻璃（单块 / 左右两块 / 左中右三块），并同步上下两半。
 */
public class BlockCRTAPGGlass2 extends BlockPSDAPGGlassBase {
	...
	private boolean isSameGlass(World world, BlockPos pos) {
		return world.getBlockState(pos).getBlock() instanceof BlockCRTAPGGlass2;
	}
