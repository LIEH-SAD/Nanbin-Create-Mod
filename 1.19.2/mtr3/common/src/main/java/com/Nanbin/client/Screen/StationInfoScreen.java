...
public class StationInfoScreen extends ScreenMapper {
	...
	protected void init() {
		...
		addDrawableChild(new ButtonWidget(centerX - BUTTON_WIDTH / 2, currentY, BUTTON_WIDTH, BUTTON_HEIGHT,
		...
		addDrawableChild(new ButtonWidget(centerX - BUTTON_WIDTH / 2, currentY, BUTTON_WIDTH, BUTTON_HEIGHT,
				...
				button -> ClientPacketHelper.openRailwaySignDoubleScreen(blockPos, isFront)));
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		final int centerX = width / 2;
		drawCenteredText(matrices, textRenderer, title, centerX, 10, COLOR_TITLE);
		drawCenteredText(matrices, textRenderer, Text.translatable("gui.nanbin.station_info.url_hint"), centerX, 28, COLOR_HINT);
